...
export function renderPaymentSummary() {
  ...
  cart.forEach((cartItem) => {
    const product = getProduct(cartItem.productId); // Ensure the product is fetched to avoid errors
  ...
  const taxCents = Math.round(totalBeforeTaxCents * 0.1); //tax = 10%
